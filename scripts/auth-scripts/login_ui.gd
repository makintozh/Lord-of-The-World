...
func _on_forgot_password_button_pressed():
	get_tree().change_scene_to_file("res://scenes/auth-scenes/forgot_password.tscn")
...
func _on_sign_up_button_pressed():
	get_tree().change_scene_to_file("res://scenes/auth-scenes/register_ui.tscn")
...
func _on_http_request_request_completed(result, response_code, headers, body):
	...
	if response_code == 200:
		...
		if logged and is_remember:
			remember_me()
		get_tree().change_scene_to_file("res://scenes/game-scenes/choice_server.tscn")
	else:
		logged = false
...
func disable_login():
	loginbutton.modulate = "ffffff78"
	loginbutton.disabled = true
	
func enable_login():
	loginbutton.modulate = "ffffffff"
