...
func _on_tavern_pressed():
	get_tree().change_scene_to_file("res://scenes/game-scenes/tavern.tscn")


func _on_biom_pressed():
	get_tree().change_scene_to_file("res://scenes/game-scenes/biom.tscn")


func _on_clans_hall_pressed():
	get_tree().change_scene_to_file("res://scenes/game-scenes/clanshall.tscn")


func _on_league_pressed():
	get_tree().change_scene_to_file("res://scenes/game-scenes/league.tscn")
