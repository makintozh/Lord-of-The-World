...
var position_reserve_player_card1 : Vector2 = Vector2(170.0, 1367.0)
var position_reserve_player_card2 : Vector2 = Vector2(280.0, 1367.0)
var position_reserve_player_card3 : Vector2 = Vector2(390.0, 1367.0)
var position_reserve_player_card4 : Vector2 = Vector2(500.0, 1367.0)
...
@export var go_duration = 0.8
@export var rotate_duration = go_duration + 0.5
@export var rotate_angle = 6.285
# 12.566- 3 оборота
# 6.285- 2 оборота


func start_card():
	var tween = create_tween().set_parallel(true).set_speed_scale(1.2)
	var rotation_tween = create_tween().set_parallel(true).set_speed_scale(1.8)
	
	rotation_tween.tween_property(player_card1, "rotation", rotate_angle, rotate_duration).set_trans(easing).set_delay(0.0)
	rotation_tween.tween_property(player_card2, "rotation", rotate_angle, rotate_duration).set_trans(easing).set_delay(0.1)
	rotation_tween.tween_property(player_card3, "rotation", rotate_angle, rotate_duration).set_trans(easing).set_delay(0.2)
	rotation_tween.tween_property(player_card4, "rotation", rotate_angle, rotate_duration).set_trans(easing).set_delay(0.5)
	rotation_tween.tween_property(player_card5, "rotation", rotate_angle, rotate_duration).set_trans(easing).set_delay(0.7)
	rotation_tween.tween_property(player_card6, "rotation", rotate_angle, rotate_duration).set_trans(easing).set_delay(0.9)
	
	
	tween.tween_property(player_card1, "position", down_gate, go_duration).set_trans(easing)
	tween.tween_property(player_card1, "position", position_player_card_1, go_duration).set_trans(easing).set_delay(0.15)
	tween.tween_property(player_card2, "position", down_gate, go_duration).set_trans(easing)
	tween.tween_property(player_card2, "position", position_player_card_2, go_duration).set_trans(easing).set_delay(0.25)
	tween.tween_property(player_card3, "position", down_gate, go_duration).set_trans(easing)
	tween.tween_property(player_card3, "position", position_player_card_3, go_duration).set_trans(easing).set_delay(0.35)
	tween.tween_property(player_card4, "position", down_gate, go_duration).set_trans(easing)
	tween.tween_property(player_card4, "position", position_player_card_4, go_duration).set_trans(easing).set_delay(0.45)
	tween.tween_property(player_card5, "position", down_gate, go_duration).set_trans(easing)
	tween.tween_property(player_card5, "position", position_player_card_5, go_duration).set_trans(easing).set_delay(0.55)
	tween.tween_property(player_card6, "position", down_gate, go_duration).set_trans(easing)
	tween.tween_property(player_card6, "position", position_player_card_6, go_duration).set_trans(easing).set_delay(0.65)
	...
	tween.tween_property(reserve_player_card1, "position", position_reserve_player_card1, go_duration).set_trans(easing).set_delay(0.85)
	tween.tween_property(reserve_player_card2, "position", position_reserve_player_card2, go_duration).set_trans(easing).set_delay(1.05)
	tween.tween_property(reserve_player_card3, "position", position_reserve_player_card3, go_duration).set_trans(easing).set_delay(1.15)
	tween.tween_property(reserve_player_card4, "position", position_reserve_player_card4, go_duration).set_trans(easing).set_delay(1.25)
	...
	tween.tween_property(enemy_card1, "position", position_enemy_card_1, go_duration).set_trans(easing).set_delay(0.15)
	tween.tween_property(enemy_card2, "position", top_gate, go_duration).set_trans(easing)
	tween.tween_property(enemy_card2, "position", position_enemy_card_2, go_duration).set_trans(easing).set_delay(0.25)
	tween.tween_property(enemy_card3, "position", top_gate, go_duration).set_trans(easing)
	tween.tween_property(enemy_card3, "position", position_enemy_card_3, go_duration).set_trans(easing).set_delay(0.35)
	tween.tween_property(enemy_card4, "position", top_gate, go_duration).set_trans(easing)
	tween.tween_property(enemy_card4, "position", position_enemy_card_4, go_duration).set_trans(easing).set_delay(0.45)
	tween.tween_property(enemy_card5, "position", top_gate, go_duration).set_trans(easing)
	tween.tween_property(enemy_card5, "position", position_enemy_card_5, go_duration).set_trans(easing).set_delay(0.55)
	tween.tween_property(enemy_card6, "position", top_gate, go_duration).set_trans(easing)
	tween.tween_property(enemy_card6, "position", position_enemy_card_6, go_duration).set_trans(easing).set_delay(0.65)
...
var across_move_time = 6

var normal_scale : Vector2 = Vector2(1.0 , 1.0)
var big_scale : Vector2 = Vector2(1.3 , 1.3)
var small_scale : Vector2 = Vector2(0.7 , 0.7)
...
func move_card(card:Node, to_card_position:Vector2):
	...
	tween.tween_property(card, "scale", big_scale, scale_duration)
	tween.chain().tween_property(card, "scale", small_scale, scale_duration)
	tween.tween_property(card, "position", to_card_position, move_duration)
	tween.chain().tween_property(card, "position", original_card_position, move_duration).set_delay(0.3)
	tween.tween_property(card, "scale", normal_scale, scale_duration).set_delay(0.2)
